                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="expired" type="text" class="form-control {{$errors->has('expired') ? 'is-invalid' : ''}}" value="{{old('expired') ?: ''}}" required />
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="card_number" type="text" class="form-control {{$errors->has('cvc') ? 'is-invalid' : ''}}" maxlength="5" value="{{old('cvc') ?: ''}}" required />
                                            @if ($errors->has('cvc'))
